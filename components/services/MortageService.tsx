    ...
    <div className="relative w-full py-8 md:py-16 lg:-mt-16">
      <div className="relative w-full max-w-[1280px] mx-auto px-4 md:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          {/* Left Side - Content */}
          <div className="relative flex flex-col lg:pl-[100px] lg:pt-[80px] order-2 lg:order-1">
            <div className="flex flex-col">
              <div>
                <div className="flex items-center mb-4">
                  ...
                  <h2 className="text-xl md:text-2xl lg:text-[24px] font-lato font-bold text-[#1C1C1C]">Our Services</h2>
                </div>
                <h3 className="text-3xl md:text-4xl lg:text-[40px] font-lato font-bold text-[#1C1C1C] leading-tight mb-4">
                  Mortgage Planning
                </h3>
          ...
          {/* Right Side - Image */}
          <div className="relative flex justify-center lg:justify-end items-center lg:items-start lg:pt-[20px] lg:pr-[100px] order-1 lg:order-2">
