...
//       <nav className={`w-full h-[60px] sm:h-[79px] flex items-center justify-between ${
//         variant === 'transparent' 
...
//                 width={80}
//                 height={51}
//                 className="object-contain w-20 sm:w-[100px]"
//                 priority
//               />
//             </Link>
//           </div>
...
//             <Link href="/" className={`font-lato font-light text-base sm:text-lg lg:text-[20px] leading-[24px] ${textColor} hover:font-bold active:font-bold whitespace-nowrap mx-2 lg:mx-4`}>
//               Home
//             </Link>
//             <Link href="/aboutus" className={`font-lato font-light text-base sm:text-lg lg:text-[20px] leading-[24px] ${textColor} hover:font-bold active:font-bold whitespace-nowrap mx-2 lg:mx-4`}>
//               About Us
//             </Link>
//             <div className="relative group">
//               <Link href="/services" className={`font-lato font-light text-base sm:text-lg lg:text-[20px] leading-[24px] ${textColor} hover:font-bold active:font-bold whitespace-nowrap flex items-center mx-2 lg:mx-4`}>
//                 Services
...
//               </div>
//             </div>
//             <Link href="/contactus" className={`font-lato font-light text-base sm:text-lg lg:text-[20px] leading-[24px] ${textColor} hover:font-bold active:font-bold whitespace-nowrap mx-2 lg:mx-4`}>
//               Contact Us
//             </Link>
//           </div>
