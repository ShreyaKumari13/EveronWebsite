...
const RatesTermsSection = () => {
  return (
    <section className="w-full bg-[#B392550D]">
      <div className="container mx-auto max-w-[1280px] px-4 md:px-[100px] py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="mt-1 whitespace-nowrap">
                <span className="font-lato text-[24px] font-normal leading-[28.8px] text-[#1C1C1C] text-left">From </span>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="mt-1 whitespace-nowrap">
                <span className="font-lato text-[24px] font-normal leading-[28.8px] text-[#1C1C1C] text-left">Only </span>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="mt-1 whitespace-nowrap">
                <span className="font-lato text-[24px] font-normal leading-[28.8px] text-[#1C1C1C] text-left">Up to </span>
