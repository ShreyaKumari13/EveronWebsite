  ...
  return (
    <section className="w-full py-8 sm:py-12 lg:py-16">
      <div className="relative w-full max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row items-start justify-between mb-8 sm:mb-12">
          <div className="relative pl-4 sm:pl-[100px] mb-4 sm:mb-0">
            <h2 className="text-2xl sm:text-3xl lg:text-[45px] font-lato font-extrabold text-[#1C1C1C] leading-tight sm:leading-[54px]">
              WHAT OUR <span className="text-[#8E8154]">CLIENT SAY</span>
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Project Image */}
          <div className="relative h-[300px] sm:h-[400px] lg:h-[498px] w-full overflow-hidden">
            <Image
              src={testimonials[currentIndex].projectImage}
              alt={testimonials[currentIndex].projectName}
              fill
          ...
          {/* Testimonial Content */}
          <div className="flex flex-col justify-center space-y-6 sm:space-y-8 pl-4 sm:pl-[60px]">
            <div>
              <h3 className="text-2xl sm:text-[32px] font-lato font-bold mb-4 text-[#1C1C1C] leading-tight sm:leading-[38.4px]">
                {testimonials[currentIndex].projectName}
              </h3>
              <p className="text-base sm:text-lg lg:text-[24px] font-lato text-[#1C1C1C] leading-relaxed sm:leading-[28.8px]">
                {testimonials[currentIndex].description}
              </p>
            </div>

            {/* Testimonial Card */}
            <div className="bg-[#B392550D] p-6 sm:p-8 rounded-[30px]">
              <blockquote className="text-base sm:text-lg lg:text-[24px] font-lato mb-4 sm:mb-6 text-[#1C1C1C] leading-relaxed sm:leading-[28.8px]">
                &ldquo;{testimonials[currentIndex].quote}&rdquo;
              </blockquote>
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-lg sm:text-xl lg:text-[24px] font-lato font-bold text-[#1C1C1C]">
                    {testimonials[currentIndex].author}
                  </p>
                </div>
              </div>
