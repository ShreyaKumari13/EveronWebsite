...
//             <div className="flex flex-col h-full justify-start space-y-4 md:space-y-[35px] text-center md:text-left">
//               <Link href="/" className="block text-sm md:text-[16px] font-lato hover:text-[#8E8154] transition-colors h-[24px] flex items-center">
//                 Home
//               </Link>
//               <Link href="/aboutus" className="block text-sm md:text-[16px] font-lato hover:text-[#8E8154] transition-colors h-[24px] flex items-center">
//                 About
//               </Link>
//               <Link href="/signup" className="block text-sm md:text-[16px] font-lato hover:text-[#8E8154] transition-colors h-[24px] flex items-center">
//                 Sign Up
//               </Link>
//             </div>
//           </div>
...
//           <div className="md:col-span-3 flex flex-col items-center md:items-start">
//             <div className="flex flex-col h-full justify-start space-y-4 md:space-y-[35px] text-center md:text-left">
//               <Link href="/services" className="block text-sm md:text-[16px] font-lato hover:text-[#8E8154] transition-colors h-[24px] flex items-center">
//                 Services
//               </Link>
//               <Link href="/contactus" className="block text-sm md:text-[16px] font-lato hover:text-[#8E8154] transition-colors h-[24px] flex items-center">
//                 Contact
//               </Link>
//               <Link href="/privacy" className="block text-sm md:text-[16px] font-lato hover:text-[#8E8154] transition-colors h-[24px] flex items-center">
//                 Privacy Policy
//               </Link>
//             </div>
//           </div>
...
//             <div className="flex gap-4 md:gap-6 justify-center md:justify-start mb-4 md:mb-[35px]">
//               <Link 
...
//               <Link href="https://klyngon.com/everonprop_erp/authentication" className="cursor-pointer w-auto" target="_blank" rel="noopener noreferrer">
//                 <AnimatedButton
